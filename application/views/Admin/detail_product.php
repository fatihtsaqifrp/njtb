            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Detail Product</h4> </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="white-box">
                            ...
                            <form class="form-horizontal form-material" enctype="multipart/form-data" method="post" accept-charset="utf-8" action="<?= base_url("Admin/saveproduct/".$data['id'])?>">
                                <div class="form-group">
                                    <label class="col-md-12">Nama Barang</label>
                                    <div class="col-md-12">
                                        <input type="text" value="<?= $data['nama_barang']; ?>" name="nama_barang" placeholder="nama produk"  class="form-control form-control-line"> </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="number" name="stok_barang" value="<?= $data['stok_barang']; ?>" placeholder="100" class="form-control form-control-line"> </div>
                                </div>
                                <div class="form-group">
                                    <label for="example-email" class="col-md-12">Harga Barang</label>
                                    <div class="col-md-12">
                                    <input type="number" name="harga_barang" value="<?= $data['harga_barang']; ?>" placeholder="125000" class="form-control form-control-line"> </div>
                                </div>
                                <div class="form-group">
                                    <label for="example-email" class="col-md-12">Tanggal Barang</label>
                                    <div class="col-md-12">
                                    <input placeholder="masukkan tanggal Product" type="text" value="<?= gmdate("d/m/Y",$data['tgl_barang']); ?>" class="form-control datepicker" name="tgl_barang">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12">Keterangan Barang</label>
                                    <div class="col-md-12">
                                    <textarea rows="5" name="ket_barang"  class="form-control form-control-line"><?= $data['keterangan_barang']; ?></textarea>
                                    </div>
                                </div>
                                ...
                                <center>
                                     <div class="panel-body"><img src="<?= $pic; ?>" width="200px;"></div>
                                     </center><div class="panel-footer"><input type="file" name="imageURL" id="url" class="form-control" data-icon="false" data-buttontext="Choose image"></div>
                                    </div>
                                    </div>
                                </div>
                                <div class="form-group">
