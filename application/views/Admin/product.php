                        ...
                        <div class="table-responsive">
                                <table class="table">
                                    ...
                                    foreach ($data as $row)
                                    {
                                        ...
                                        echo '
                                        <td>
                                        <button type="button" class="btn btn-default" onclick="window.location=\''.base_url("admin/detail_product/".$row->id).'\';">Sunting</button>
                                        <button type="button" class="btn btn-danger" onclick="window.location=\''.base_url("admin/deleteproduct/".$row->id).'\';">Hapus</button>
                                        </td>';
                                        echo "</tr>";
                                    }
