...
<div id="tour" class="bg-1" style="padding-top:70px !important;">
  <div class="container" style="padding:10px !important;">
  
	  <ul class="nav nav-tabs">
    <li class="active"><a data-toggle="tab" href="#home">Jaket</a></li>
    <li><a data-toggle="tab" href="#menu2">Sweater</a></li>
    <li><a data-toggle="tab" href="#menu1">Hoodie</a></li>
  </ul>
    ...
    <div id="home" class="tab-pane fade in active">
      <h2>Jaket</h2>
        ...
        <?php
 foreach ($jacket as $row)
 {
		  ?>
      <div class="col-sm-4">
      <div class="thumbnail" style="height:450px;">
          <img src="<?= base_url("assets/uploads/".$row['pic']); ?>" alt="" style="height:300px;">
          <p><strong><?= $row['nama_barang']; ?></strong></p>
          <p>Rp.<?= $row['harga_barang']; ?> | Stok : <?= $row['stok_barang']; ?></p>
		  <button class="btn" onclick="window.location='<?= base_url("store/detail/" . $row['id'] ); ?>';">Detail</button>
          <button class="btn" onclick="addcart('<?= $row['id']; ?>');">Tambah ke keranjang</button>
        </div>
      </div>
<?php
}
